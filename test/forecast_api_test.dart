...
const String _base_url = 'api.openweathermap.org';
...
void main() {
  group('Fetch Forecasts', () {
    ...
    Uri request;
    setUp(() async {
      request = Uri.https(_base_url, '/data/2.5/forecast', {'id': '292223', 'appid' : '03297d312f41aeb574c6e709d61e33a7'});
